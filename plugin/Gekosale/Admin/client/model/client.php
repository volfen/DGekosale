...
class ClientModel extends Component\Model\Datagrid
{
	...
	public function getClientView ($id)
	{
		...
		throw new CoreException(_('ERR_CLIENT_NO_EXIST'));
	}
	...
	public function addNewClient ($Data, $password)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_NEWCLIENT_ADD'), 125, $e->getMessage());
		}
	...
	protected function addClientAddress ($Data, $ClientId)
	{
		foreach ($Data['street'] as $key => $street){
			...
			try{
				...
				throw new CoreException(_('ERR_CLIENTADRESS_ADD'), 125, $e->getMessage());
			}
		}
		return $Data;
	}
	...
	protected function addClientData ($Data, $ClientId)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_CLIENTDATA_ADD'), 4, $e->getMessage());
		}
		return true;
	}
	...
	public function editClient ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_CLIENT_EDIT'), 125, $e->getMessage());
		}
	...
	public function editClientData ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_CLIENTDATA_UPDATE'), 1, $e->getMessage());
		}

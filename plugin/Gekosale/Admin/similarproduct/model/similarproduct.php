...
class SimilarProductModel extends Component\Model\Datagrid
{
	...
	public function getSimilarView ($id)
	{
		...
		if ($rs){
			...
			throw new CoreException(_('ERR_SIMILARPRODUCT_NO_EXIST'));
		}
		return $Data;
	}
	...
	public function addNewRelated ($Data)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_SIMILAR_PRODUCT_NEW_ADD'), 12, $e->getMessage());
		}
	...
	public function addSimilarProduct ($Data, $id)
	{
		foreach ($Data as $value){
			...
			try{
				...
				throw new CoreException(_('ERR_SIMILAR_PRODUCT_ADD'), 11, $e->getMessage());
			}
		}
	}

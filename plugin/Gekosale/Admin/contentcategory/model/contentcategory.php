...
class ContentCategoryModel extends Component\Model
{
	...
	public function addEmptyCategory ($request)
	{
		$data = Array(
			...
			'header' => 1,
			'footer' => 1,
			'name' => (isset($request['name']) && strlen($request['name'])) ? $request['name'] : _('TXT_NEW_CATEGORY'),
	...
	public function addNewContentCategory ($Data)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_CONTENT_CATEGORY_ADD'), 11, $e->getMessage());
		}
	...
	public function addContentCategory ($Data)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_CONTENT_CATGEORY_ADD'), 4, $e->getMessage());
		}
	...
	public function addContentCategoryTranslation ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_CONTENT_CATEGORY_TRANSLATION_ADD'), 13, $e->getMessage());
		}
	}
	...
	public function addContentCategoryView ($Data, $contentcategoryid)
	{
		foreach ($Data as $value){
			...
			try{
				...
				throw new CoreException(_('ERR_CONTENT_CATGEORY_VIEW_ADD'), 4, $e->getMessage());
			}
		}
	}
	...
	public function getContentCategoryView ($id)
	{
		...
		if ($rs){
			...
			throw new CoreException(_('ERR_CONTENT_CATEGORY_NO_EXIST'));
		}
		return $Data;
	}
	...
	public function editContentCategory ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_CONTENT_CATEGORY_EDIT'), 125, $e->getMessage());
		}
	...
	public function updateContentCategory ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_CONTENT_CATEGORY_EDIT'), 13, $e->getMessage());
		}
	}
		...
		if (! empty($Data)){
			foreach ($Data as $value){
				...
				try{
					...
					throw new CoreException(_('ERR_CONTENT_CATEGORY_VIEW_EDIT'), 4, $e->getMessage());
				}
			}
		}
	}

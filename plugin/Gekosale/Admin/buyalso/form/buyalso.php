...
class BuyAlsoForm extends Component\Form
{
	...
	public function initForm ()
	{
		...
		$requiredData->AddChild(new FormEngine\Elements\MultiSelect(Array(
			'name' => 'products',
			'label' => _('TXT_BUY_ALSO_LIST'),
			'options' => FormEngine\Option::Make(App::getModel('buyalso')->getProductAlsoToSelect())
		)));
		
		$Data = Event::dispatch($this, 'admin.buyalso.initForm', Array(
			'form' => $form,

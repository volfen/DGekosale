...
class RangeTypeModel extends Component\Model\Datagrid
{
	...
	public function addNewRangeType ($Data)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_NEW_RANGETYPE_ADD'), 125, $e->getMessage());
		}
	...
	public function addRangeType ($Data)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_NEW_RANGE_TYPE_ADD'), 15, $e->getMessage());
		}
	...
	public function editRangeType ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_RANGETYPE_EDIT'), 125, $e->getMessage());
		}

...
class RangeTypeController extends Component\Controller\Admin
{
	...
	public function add ()
	{
		...
		$languageData->AddChild(new FormEngine\Elements\TextField(Array(
			...
			'rules' => Array(
				...
				new FormEngine\Rules\LanguageUnique(_('ERR_NAME_ALREADY_EXISTS'), 'rangetypetranslation', 'name')
			)
		)));
		
		$categoryData = $form->AddChild(new FormEngine\Elements\Fieldset(Array(
			'name' => 'category_data',
			'label' => _('TXT_CATEGORY_DATA')
		)));
	...
	public function edit ()
	{
		...
		$languageData->AddChild(new FormEngine\Elements\TextField(Array(
			...
			'rules' => Array(
				new FormEngine\Rules\Required(_('ERR_EMPTY_NAME')),
				new FormEngine\Rules\LanguageUnique(_('ERR_NAME_ALREADY_EXISTS'), 'rangetypetranslation', 'name', null, Array(
					'column' => 'rangetypeid',

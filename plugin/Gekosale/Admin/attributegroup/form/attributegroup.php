...
class AttributeGroupForm extends Component\Form
{
	...
	public function initForm ()
	{
		...
		$groupData = $form->AddChild(new FormEngine\Elements\Fieldset(Array(
			'name' => 'group_data',
			'class' => 'group-data',
			'label' => _('TXT_ATTRIBUTE_GROUP_DATA')
		)));
		
		$groupData->AddChild(new FormEngine\Elements\TextField(Array(
			'name' => 'attributegroupname',
			'label' => _('TXT_ATTRIBUTE_GROUP_NAME'),
			'rules' => Array(
				new FormEngine\Rules\Required(_('ERR_EMPTY_ATTRIBUTE_GROUP_NAME')),
				new FormEngine\Rules\Unique(_('ERR_ATTRIBUTE_PRODUCT_GROUP_ALREADY_EXISTS'), 'attributegroupname', 'name', null, Array(

...
class CurrenciesListModel extends Component\Model\Datagrid
{
	...
	public function doAJAXUpdateCurrencieslist ($datagridId, $id)
	{
		...
		try{
			...
			$objResponse->script("GF_Alert('{_('ERR_UNABLE_TO_REFRESH_CURRENCY')}', '{$e->getMessage()}');");
			return $objResponse;
		}
	}
	...
	public function deleteCurrency ($id)
	{
		...
		if ($rs['total'] == 0){
			...
			return Array(
				'error' => _('ERR_BIND_SELLCURRENCY_PRODUCT')
			);
		}
	...
	public function addCurrencieslist ($Data)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_CURRENCY_ADD'), 4, $e->getMessage());
		}
	...
	public function addCurrencyView ($Data, $id)
	{
		foreach ($Data as $value){
			...
			try{
				...
				throw new CoreException(_('ERR_CURRENCY_VIEW_ADD'), 4, $e->getMessage());
			}
		}
	}
	...
	public function editCurrencieslist ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_CURRENCIES_LIST_ADD'), 4, $e->getMessage());
		}
	...
	{
		$this->registry->cache->delete('currencies');
	}
}
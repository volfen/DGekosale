...
class UpsellModel extends Component\Model\Datagrid
{
	...
	public function getUpsellView ($id)
	{
		...
		if ($rs){
			...
			throw new CoreException(_('ERR_UPSELL_NO_EXIST'));
		}
		return $Data;
	}
	...
	public function addNewRelated ($Data)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_UP_SELL_NEW_ADD'), 12, $e->getMessage());
		}
	...
	public function addUpSell ($Data, $id)
	{
		foreach ($Data as $value){
			...
			try{
				...
				throw new CoreException(_('ERR_UP_SELL_ADD'), 11, $e->getMessage());
			}
		}
	}
	...
	public function editRelated ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_UP_SELL_EDIT'), 10, $e->getMessage());
		}

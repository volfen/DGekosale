...
class OrderStatusGroupsModel extends Component\Model\Datagrid
{
	...
	public function getOrderStatusGroupsView ($id)
	{
		...
		if ($rs){
			...
			throw new CoreException(_('ERR_ORDER_STATUS_GROUPS_NO_EXIST'));
		}
		return $Data;
	}
	...
	public function addNewOrderStatusGroups ($Data)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_ORDER_STATUS_GROUPS_ADD'), 11, $e->getMessage());
		}
	...
	public function addOrderStatusGroups ($Data)
	{
		...
		foreach ($Data['name'] as $key => $val){
			...
			try{
				...
				throw new CoreException(_('ERR_ORDER_STATUS_GROUP_ADD'), 15, $e->getMessage());
			}
		}
	...
	public function editOrderStatusGroups ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_ORDER_STATUS_GROUPS_EDIT'), 125, $e->getMessage());
		}

...
class DelivererModel extends Component\Model\Datagrid
{
	...
	public function editDeliverer ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_DELIVERER_EDIT'), 10, $e->getMessage());
		}
	...
	public function addNewDeliverer ($Data)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_DELIVERER_ADD'), 11, $e->getMessage());
		}
	...
	public function addDeliverer ($Data)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_DELIVERER_ADD'), 15, $e->getMessage());
		}

	...
	public function initForm ()
	{
		...
		$languageData->AddChild(new FormEngine\Elements\TextField(Array(
			...
			'rules' => Array(
				...
				new FormEngine\Rules\LanguageUnique(_('ERR_NAME_ALREADY_EXISTS'), 'deliverertranslation', 'name', null, Array(
					'column' => 'delivererid',
		...
		$languageData->AddChild(new FormEngine\Elements\TextField(Array(
			'name' => 'email',
			'label' => _('TXT_EMAIL'),
			'comment' => _('TXT_EXAMPLE') . ': gekosale@gekosale.pl',
			'rules' => Array(

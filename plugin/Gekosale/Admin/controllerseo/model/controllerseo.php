...
class ControllerSeoModel extends Component\Model\Datagrid
{
	...
	public function updateControllerSeo ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_CONTROLLER_EDIT'), 125, $e->getMessage());
		}
	...
	public function editController ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_CONTROLLER_UPDATE'), 1, $e->getMessage());
		}
		return true;
	}
	...
	{
		$this->registry->cache->delete('seocontrollers');
	}

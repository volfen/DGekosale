	...
	public function index ()
	{
		...
		if ((int)$this->getParam() == 0){
			...
			$requiredData = $form->AddChild(new FormEngine\Elements\Fieldset(Array(
				'name' => 'type_pane',
				'label' => _('TXT_EXCHANGE_TYPE_MIGRATION_SETTINGS')
			)));
			...
			$requiredData->AddChild(new FormEngine\Elements\Select(Array(
				'name' => 'entity',
				'label' => _('TXT_EXCHANGE_ENTITY'),
				'options' => Array(
					new FormEngine\Option(1, _('TXT_PRODUCTS')),
					new FormEngine\Option(2, _('TXT_CATEGORIES')),
					new FormEngine\Option(3, _('TXT_PRODUCERS')),
					new FormEngine\Option(4, _('TXT_PHOTOS')),
					new FormEngine\Option(5, _('TXT_ATTRIBUTES'))	,
					new FormEngine\Option(6, _('TXT_ORDERS'))	,
					new FormEngine\Option(7, _('TXT_SIMILARPRODUCT'))	,
				),
				'default' => 1
			)));

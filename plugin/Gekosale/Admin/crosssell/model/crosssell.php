...
class CrossSellModel extends Component\Model\Datagrid
{
	...
	public function getCrossSellView ($id)
	{
		...
		if ($rs){
			...
			throw new CoreException(_('ERR_CROSSSELL_NO_EXIST'));
		}
		return $Data;
	}
	...
	public function addNewRelated ($Data)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_CROSS_SELL_NEW_ADD'), 12, $e->getMessage());
		}
	...
	public function addCrossSell ($Data, $id)
	{
		foreach ($Data as $value){
			...
			try{
				...
				throw new CoreException(_('ERR_CROSS_SELL_ADD'), 11, $e->getMessage());
			}
		}
	}
	...
	public function editRelated ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_CROSS_SELL_EDIT'), 10, $e->getMessage());
		}

...
class GroupsModel extends Component\Model\Datagrid
{
	...
	protected function editGroup ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_GROUP_EDIT'), 13, $e->getMessage());
			return false;
		}
		return true;
	}
	...
	protected function addGroup ($Data)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_GROUP_ADD'), 14, $e->getMessage());
		}
	...
	public function add ($Data)
	{
		...
		try{
			...
			throw new Exception(_('ERR_GROUP_ADD_ERROR'), 3001, $e->getMessage());
		}

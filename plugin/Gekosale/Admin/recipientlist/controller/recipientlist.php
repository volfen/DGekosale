...
class recipientlistController extends Component\Controller\Admin
{
	...
	public function edit ()
	{
		...
		$requiredData->AddChild(new FormEngine\Elements\TextField(Array(
			...
			'rules' => Array(
				new FormEngine\Rules\Required(_('ERR_EMPTY_NAME')),
				new FormEngine\Rules\Unique(_('ERR_NAME_ALREADY_EXISTS'), 'recipientlist', 'name', null, Array(

...
class ProducerModel extends Component\Model\Datagrid
{
	...
	public function addProducer ($Data)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_PRODUCER_ADD'), 15, $e->getMessage());
		}
	...
	public function updateProducerPhoto ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_PRODUCER_EDIT'), 15, $e->getMessage());
		}
	}
	...
	public function addView ($Data, $id)
	{
		foreach ($Data as $value){
			...
			try{
				...
				throw new CoreException(_('ERR_PRODUCER_VIEW_EDIT'), 4, $e->getMessage());
			}
		}
	}

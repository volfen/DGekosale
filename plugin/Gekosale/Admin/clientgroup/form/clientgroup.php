...
class ClientGroupForm extends Component\Form
{
	...
	public function initForm ()
	{
		...
		$languageData->AddChild(new FormEngine\Elements\TextField(Array(
			'name' => 'name',
			'label' => _('TXT_GROUP_NAME'),
			'rules' => Array(
				new FormEngine\Rules\Required(_('ERR_EMPTY_GROUP_NAME')),
				new FormEngine\Rules\LanguageUnique(_('ERR_GROUP_NAME_ALREADY_EXISTS'), 'clientgrouptranslation', 'name', null, Array(
	...
	protected function getClientDatagridColumns ()
	{
		return Array(
			...
			Array(
				'id' => 'clientorder',
				'caption' => _('TXT_CLIENTORDER_VALUE'),
				'appearance' => Array(
					'width' => 60,
					'visible' => false,

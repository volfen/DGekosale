...
class NewsletterModel extends Component\Model\Datagrid
{
	...
	public function getNewsletterData ($id)
	{
		...
		if ($rs){
			...
			throw new CoreException(_('ERR_NEWSLETTER_NO_EXIST'));
		}
		return $Data;
	}
	...
	public function addNewsletter ($Data)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_NEWSLETTER_ADD'), 11, $e->getMessage());
		}
		...
		if (is_array($Data['groups'])){
			foreach ($Data['groups'] as $value){
				...
				try{
					...
					throw new CoreException(_('ERR_CLIENT_GROUP_NEWSLETTER_ADD'), 112, $e->getMessage());
				}
			}
		}
		else{
			...
			try{
				...
				throw new CoreException(_('ERR_CLIENT_GROUP_NEWSLETTER_ADD'), 11, $e->getMessage());
			}
		}
	...
	public function updateNewsletter ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_NEWSLETTER_EDIT'), 3002, $e->getMessage());
		}
	...
	public function editNewsletter ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_NEWSLETTER_EDIT'), 13, $e->getMessage());
			return false;
		}
		return true;
	}

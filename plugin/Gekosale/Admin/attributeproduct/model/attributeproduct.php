...
class AttributeProductModel extends Component\Model\Datagrid
{
	...
	public function addAttributeGroup ($Data)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_WHILE_ATTRIBUTE_PRODUCT_GROUP_ADD'), 114, $e->getMessage());
		}
	...
	public function getAttributeProductName ($id)
	{
		...
		if ($rs){
			...
			throw new CoreException(_('ERR_ATTRIBUTEGROUP_NO_EXIST'));
		}
		return $Data;
	}
	...
	public function updateAttribute ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_ATTRIBUTES_EDIT'), 125, $e->getMessage());
		}
	...
	public function updateAttributeGroupName ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_ATTRIBUTE_GROUP_UPDATE'), 1, $e->getMessage());
			return false;
		}
		return true;
	}

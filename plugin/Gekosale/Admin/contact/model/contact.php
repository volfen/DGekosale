...
class ContactModel extends Component\Model\Datagrid
{
	...
	public function updateContact ($publish, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_CONTACT_EDIT'), 13, $e->getMessage());
		}
	}
	...
	public function updateContactTranslation ($Data, $id)
	{
		...
		foreach ($Data['name'] as $key => $val){
			...
			try{
				...
				throw new CoreException(_('ERR_CONTACT_TRANSLATION_EDIT'), 13, $e->getMessage());
			}
		}
	}
	...
	public function addContactView ($array, $id)
	{
		foreach ($array as $value){
			...
			try{
				...
				throw new CoreException(_('ERR_CONTACT_VIEW_ADD'), 4, $e->getMessage());
			}
		}
	}
	...
	public function addContactTranslation ($Data, $id)
	{
		foreach ($Data['name'] as $key => $val){
			...
			try{
				...
				throw new CoreException(_('ERR_CONTACT_TRANSLATION_ADD'), 13, $e->getMessage());
			}
		}
	}
}
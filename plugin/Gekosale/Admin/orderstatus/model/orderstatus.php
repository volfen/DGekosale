...
class OrderStatusModel extends Component\Model\Datagrid
{
	...
	public function deleteOrderstatus ($id)
	{
		...
		if ($rs['total'] == 0 && $rs2['total'] == 0){
			...
			return Array(
				'error' => _('ERR_ORDERSTATUS_USED_IN_ORDERS')
			);
		}
	}
	...
	public function addNewOrderstatus ($Data)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_ORDER_STATUS_ADD'), 11, $e->getMessage());
		}
	...
	public function addOrderStatus ($Data)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_ORDERSTATUS_ADD'), 11, $e->getMessage());
		}
		...
		foreach ($Data['name'] as $key => $val){
			...
			try{
				...
				throw new CoreException(_('ERR_ORDERSTATUS_ADD'), 15, $e->getMessage());
			}
		}
	...
	public function editOrderstatus ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_ORDER_STATUS_EDIT'), 125, $e->getMessage());
		}
		Db::getInstance()->commit();
		return true;
	}
	...
	public function updateOrderstatus ($Data, $id)
	{
		...
		foreach ($Data['name'] as $key => $val){
			...
			try{
				...
				throw new CoreException(_('ERR_ORDERSTATUS_EDIT'), 129, $e->getMessage());
			}
		}
		return true;
	}
	...
	public function getOrderstatusView ($id)
	{
		...
		if ($rs){
			...
			throw new CoreException(_('ERR_ORDERSTATUS_NO_EXIST'));
		}
		return $Data;
	}
	...
	public function doAJAXDefault ($datagridId, $id)
	{
		try{
			...
			$objResponse->script("GF_Alert('{_('ERR_SET_DEFAULT_ORDER_STATUS')}', '{$e->getMessage()}');");
			return $objResponse;
		}
	}

...
class LanguageModel extends Component\Model\Datagrid
{
	...
	public function updateLanguage ($Data, $id)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_LANGUAGE_EDIT'), 13, $e->getMessage());
			return false;
		}
		return true;
	}
	...
	public function addLanguage ($Data)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_LANGUAGE_ADD'), 14, $e->getMessage());
		}
	...
	public function addNewLanguage ($Data)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_LANGUAGE_ADD'), 11, $e->getMessage());
		}
		
		Db::getInstance()->commit();
		$this->registry->cache->delete('languages');
		return true;
	}
	...
	public function importTranslationFromFile ($file, $languageid)
	{
		...
		try{
			...
			throw new CoreException(_('ERR_LANGUAGE_IMPORT'), 11, $e->getMessage());
		}
	}

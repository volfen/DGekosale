 ...
 * $Id: productssimilarbox.php 602 2011-11-07 21:45:33Z gekosale $
 */

namespace Gekosale;

class ProductsSimilarBoxController extends Component\Controller\Box
{

	public function __construct ($registry, $box)
	{
		parent::__construct($registry, $box);
		$dataset = App::getModel('productssimilarbox')->getDataset();
		...
		$products = App::getModel('productssimilarbox')->getProductDataset();

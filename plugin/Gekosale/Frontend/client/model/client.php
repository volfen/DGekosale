...
class ClientModel extends Component\Model
{
	...
	public function getClientPass ()
	{
		...
		if ($rs){
			...
			throw new FrontendException(_('ERR_PASSWORD_NOT_EXIST'));
		}
		return $Data;
	}
	...
	public function addNewClient ($Data, $password = null)
	{
		...
		try{
			...
			throw new FrontendException(_('ERR_NEWCLIENT_ADD'), 125, $e->getMessage());
		}
	...
	public function updateClientDisable ($id, $disable, $activelink = NULL)
	{
		...
		try{
			...
			throw new FrontendException(_('ERR_CLIENT_ADD'), 4, $e->getMessage());
		}
		return $activelink;
	}
	...
	protected function addClientData ($Data, $ClientId)
	{
		...
		try{
			...
			throw new FrontendException(_('ERR_CLIENTDATA_ADD'), 4, $e->getMessage());
		}
		return true;
	}
	...
	public function updateClientEmail ($Data)
	{
		...
		try{
			$stmt->execute();
			Session::setActiveClientEmail($Data['email']);
		}
		catch (Exception $e){
			throw new FrontendException($e->getMessage());
		}

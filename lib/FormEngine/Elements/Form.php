...
class Form extends Container
{
	...
	public function __construct ($attributes)
	{
		...
		if (! isset($this->_attributes['csrf'])){
			$this->_attributes['csrf'] = true;
		}
	...
	public function Validate ($values = Array())
	{
		...
		if ($this->_attributes['csrf'] == true){
			$this->form->AddChild(new TextFieldCSRF(array(
				'name' => '__csrf',
				'default' => App::getModel('csrfprotection')->getCode(),
				'rules' => array(
					new Rules\Required(Translation::get('ERR_CSRF')),
					new Rules\Custom(Translation::get('ERR_CSRF'), array(

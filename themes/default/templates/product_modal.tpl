...
<div class="modal-body">
	...
	<div id="addToCart" class="well well-small">
		...
		<div class="hr"></div>
			...
			<button type="submit" onclick="$('#productModal').modal('hide');xajax_addProductToCart({{ product.idproduct }}, $('#attributevariants').val(), $('#product-qty').val());return false;" class="btn btn-primary btn-large available marginbt10" id="add-cart"><i class="icon-shopping-cart icon-white"></i> Do koszyka </button>

...
$this->routes->add('frontend.producerlist', new Route('/' . Seo::getSeo('producerlist') . '/{param},{currentPage},{orderBy},{orderDir},{viewType},{priceFrom},{priceTo},{producers},{attributes}', array(
	'mode' => 'frontend',
...
$this->routes->add('frontend.categorylist', new Route('/' . Seo::getSeo('categorylist') . '/{param},{currentPage},{orderBy},{orderDir},{viewType},{priceFrom},{priceTo},{producers},{attributes}', array(
	'mode' => 'frontend',
